---
title: Community
description: Repository, contributing, and conformance for the ECP open protocol.
---
...
The protocol, schemas, SDK, and runtime are released under the Apache License 2.0. See the [repository](https://github.com/evaluation-context-protocol/evaluationcontextprotocol) for details.
